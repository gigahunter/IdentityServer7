...
{
    public class CustomAuthorizeInteractionResponseGenerator : IdentityServer7.ResponseHandling.AuthorizeInteractionResponseGenerator
    {
        public CustomAuthorizeInteractionResponseGenerator(ISystemClock clock, ILogger<IdentityServer7.ResponseHandling.AuthorizeInteractionResponseGenerator> logger, IConsentService consent, IProfileService profile) : base(clock, logger, consent, profile)
        {
        }
    ...
    public class AuthorizeInteractionResponseGeneratorTests_Custom
    {
        ...
        public AuthorizeInteractionResponseGeneratorTests_Custom()
        {
            _subject = new CustomAuthorizeInteractionResponseGenerator(
                _clock,
                TestLogger.Create<IdentityServer7.ResponseHandling.AuthorizeInteractionResponseGenerator>(),
                _mockConsentService,
